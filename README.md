...
ExWeave 把 **数十份聊天记录**（私聊 + 群聊）构建成一个 **数百人、数万条消息的 Neo4j 社会关系网络**，然后用这个网络来增强对话仿真：
...
本项目受到 [ex-skill](https://github.com/perkfly/ex-skill) 的启发——将聊天记录蒸馏为 AI 对话人物的原始想法来自那里。ExWeave 在此基础上将视角从单人扩展到整个社会网络。
